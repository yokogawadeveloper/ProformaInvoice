...
export class ApiService {
  ...
  // Gautam Ankul
  getUserDropdownData(): Observable<any> {
    return this.http.get(this.apiUrl + 'user/getuser/');
  }

  getGrantSuperuserListData(): Observable<any> {
    return this.http.get(this.apiUrl + 'user/getgrantsuperuser/');
  }

  updateProformaAccess(data): Observable<any> {
    return this.http.post(this.apiUrl + 'user/updateuseraccess/', data);
  }

  updateProformaAccessForNoneSuperUser(data): Observable<any> {
    console.log(data);
    return this.http.post(this.apiUrl + 'user/updateuseraccessfornonesuperuser/', data);
  }
